...
public class Admin_01_Create_View_Edit_Delete extends AbstractTest {
	...
	public void Post_01_Create_New_Post_At_Admin_Page() {
		...
		newEditPostAdminPage.uploadMultipleFiles(driver, "kia-seltos.jpg");

		verifyTrue(newEditPostAdminPage.areFileUplaodedDisplayed(driver, "kia-seltos.jpg"));

		newEditPostAdminPage.clickToSetFeatureImageButton();

		newEditPostAdminPage.clickToPublishButton();

		verifyTrue(newEditPostAdminPage.isSuccessMessageDisplayedWithValue("New Post Created"));
		...
		verifyTrue(homeUserPage.isNewPostDisplayedOnLatestPost("category", "title", "created date"));
		verifyTrue(homeUserPage.isPostImageDisplayedAtPostTitleName("title", "kia-seltos.jpg"));
		...
		verifyTrue(searchResultsUserPage.isNewPostDisplayedOnLatestPost("category", "title", "created date"));
